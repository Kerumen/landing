  ...
  return (
    <div className={styles.container}>
      <div className={styles.inner}>
        <Title style={{ textAlign: 'right', marginBottom: 15 }}>8499 ETH</Title>
          ...
          <div key={index} className={styles.stage}>
            ...
            <div style={{ opacity: index >= 2 ? 0.5 : 1 }}>
              ...
              <div className={styles.stageContent}>
                ...
                lobortis eget libero eget consectetur. Sed a luctus mauris, sit
                amet rhoncus justo. Donec quis imperdiet ligula.
              </div>
            </div>
          </div>
        ))}
